...
exports.default = exports.View = exports.transitionEndEventName = exports.transitionStartEventName = void 0;
      ...
      if (platform === _platform.IOS && _this.context.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          _this.setState({
            ...
            scrolls: (0, _objectSpread4.default)({}, _this.state.scrolls, (0, _defineProperty2.default)({}, _this.state.activePanel, _this.window.pageYOffset))
          });
        }
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        this.setState({
          ...
          activePanel: null,
          animated: true,
          scrolls: (0, _objectSpread4.default)({}, prevState.scrolls, (0, _defineProperty2.default)({}, prevProps.activePanel, this.window.pageYOffset)),
          isBack: isBack
        });
